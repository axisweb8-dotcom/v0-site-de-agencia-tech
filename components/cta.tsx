...
const WHATSAPP_MESSAGE = "Olá! Vim pelo site da Axis Web e gostaria de agendar uma consultoria gratuita."
        ...
        <AnimateOnScroll>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button 
              asChild
              size="lg" 
              className="bg-[#f6c72d] hover:bg-[#e5b828] text-black h-16 px-12 text-lg font-semibold gap-3 rounded group transition-all duration-300 hover:scale-[1.02]"
            >
