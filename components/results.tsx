          ...
          {cases.map((caseStudy) => (
            ...
            >
              <div className="flex items-center justify-between mb-8">
                ...
                <div className="w-10 h-10 rounded border border-white/10 flex items-center justify-center group-hover:border-[#f6c72d]/50 group-hover:bg-[#f6c72d]/10 transition-all">
                  <ArrowUpRight className="w-4 h-4 text-white/40 group-hover:text-[#f6c72d] transition-colors" />
                </div>
              </div>
